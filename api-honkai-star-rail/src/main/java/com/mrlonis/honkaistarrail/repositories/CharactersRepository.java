...
public interface CharactersRepository extends JpaRepository<Character, UUID> {
    ...
    List<Character> findByOrnamentSetOneIdIsOrOrnamentSetTwoIdIs(
            @Param("ornamentSetOneId") UUID ornamentSetOneId, @Param("ornamentSetTwoId") UUID ornamentSetTwoId);

    List<Character> findByOrnamentSetOneIdIsOrOrnamentSetTwoIdIsOrOrnamentSetThreeIdIs(
            @Param("ornamentSetOneId") UUID ornamentSetOneId,
            @Param("ornamentSetTwoId") UUID ornamentSetTwoId,
            @Param("ornamentSetThreeId") UUID ornamentSetThreeId);

    List<Character> findByRelicSetOneIdFirstIsOrRelicSetOneIdSecondIs(
            @Param("relicSetOneIdFirst") UUID relicSetOneIdFirst,
            @Param("relicSetOneIdSecond") UUID relicSetOneIdSecond);

    List<Character> findByRelicSetOneIdFirstIsOrRelicSetOneIdSecondIsOrRelicSetTwoIdFirstIsOrRelicSetTwoIdSecondIs(
            @Param("relicSetOneIdFirst") UUID relicSetOneIdFirst,
            @Param("relicSetOneIdSecond") UUID relicSetOneIdSecond,
