...
CREATE TABLE Characters (
    ...
    CONSTRAINT Combat_Path_Foreign_Key FOREIGN KEY (combatPathId) REFERENCES Combat_Paths (id),
    CONSTRAINT Combat_Type_Foreign_Key FOREIGN KEY (combatTypeId) REFERENCES Combat_Types (id),
    ...
    CONSTRAINT Ornament_Set_Three_Foreign_Key FOREIGN KEY (ornamentSetThreeId) REFERENCES Ornaments (id),
